...
#   institutional_email = models.EmailField(null=True)
#   nationalID = models.CharField(max_length=20)
#   nationalID_type = models.CharField(max_length=50)
#   country = models.CharField(max_length=50)
#   primary_number = models.IntegerField()
#   secondary_number = models.IntegerField(null=True)
#   userfk = models.ForeignKey(User,  on_delete=models.CASCADE)



# class Training(models.Model):
#   biofk = models.ForeignKey(BioData,  on_delete=models.CASCADE)
#   userfk = models.ForeignKey(User,  on_delete=models.CASCADE)
#   trained_in_frontline = models.CharField(max_length=3, null=True)
#   frontline_cohort_number = models.CharField(max_length=50, null=True)
#   frontline_completion_year = models.IntegerField(null=True)
#   frontline_institution_at_enrolment = models.CharField(max_length=50, null=True)
#   frontline_job_title_at_enrolment = models.CharField(max_length=100, null=True)

#   trained_in_intermediate = models.CharField(max_length=3, null=True)
#   intermediate_cohort_number = models.CharField(max_length=50), null=True
#   intermediate_completion_year = models.IntegerField()
#   intermediate_institution_at_enrolment = models.CharField(max_length=50, null=True)
#   intermediate_job_title_at_enrolment = models.CharField(max_length=100, null=True)

#   trained_in_advanced = models.CharField(max_length=3, null=True)
#   advanced_cohort_number = models.CharField(max_length=50, null=True)
#   advanced_completion_year = models.IntegerField(, null=True)
#   advanced_institution_at_enrolment = models.CharField(max_length=50, null=True)
#   advanced_job_title_at_enrolment = models.CharField(max_length=100, null=True)


# class Occupation(models.Model):
#   trainingfk = models.ForeignKey(Training,  on_delete=models.CASCADE)
#   userfk = models.ForeignKey(User,  on_delete=models.CASCADE)
#   current_institution = models.CharField(max_length=100)
#   current_job = models.CharField(max_length=100, null=True)
#   region = models.CharField(max_length=100)
#   district = models.CharField(max_length=100)
#   health_system_level = models.CharField(max_length=100)
