...
class UserProfileAdmin(admin.ModelAdmin):
	list_display = ['id', 'title', 'surname', 'firstname', 'status', 'sex', 'phone1', 'is_trained_frontline', 'cohort_number_frontline', 'yr_completed_frontline', 'institution_enrolled_at_frontline',
