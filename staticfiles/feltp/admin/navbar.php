...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=map" class="nav-item nav-alumni"><span class='icon-field'><i class="fas fa-map-marker-alt"></i></span> Map</a>
				...
				<a href="index.php?page=news" class="nav-item nav-forums"><span class='icon-field'><i class="fa fa-comments"></i></span> News</a>
